...
parser.add_argument("--test_dataset_path",type=str,default='C:/Users/felip/Desktop/Experiment_24-05-2023/processed/ref/test6/256/')
parser.add_argument("--results_path",type=str,default='C:/Users/felip/Desktop/Experiment_24-05-2023/processed/ref/test6/256r_film/')
parser.add_argument("--mask_path",type=str,default='./masks/shutter_mask16.mat')
parser.add_argument("--model_module",type=str,default='FILM')
