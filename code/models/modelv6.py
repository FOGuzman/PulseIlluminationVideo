...
class cnnModel(nn.Module):
    def __init__(self,color_channels=1,units=2,dim=64,frames=8):
        ...
        self.invNet1 = UNet(in_channels=3, out_channels=frames)
        self.invNet2 = UNet(in_channels=3, out_channels=frames)
        self.invNet3 = UNet(in_channels=3, out_channels=frames)
